      ...
      <div className="grid grid-cols-1 md:grid-cols-2 p-4">
        ...
        <div className="flex flex-col justify-end text-center align-middle md:text-left md:mb-8 mt-8 pl-0 md:pl-8">
          ...
          <div className="purchase-links">
            <span className='font-bold align-middle mr-4'>Buy</span>
          ...
          <div className="streaming-links">
            <span className='font-bold align-middle mr-4'>Stream</span>
          ...
          <div className="social-icons">
            <span className='font-bold align-middle mr-4'>Follow</span>
